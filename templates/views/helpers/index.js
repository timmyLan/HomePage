...
module.exports = function () {
	...
	// output. 'Filed Undder <a href="detail/tech">tech</a>, <a href="detail/js">js</a>'
	...
	_helpers.postUrl = function (postSlug, options) {
		return ('/detail/post/' + postSlug);
	};

	// might be a ghost helper
	// used for pagination urls on detail
	_helpers.pageUrl = function (pageNumber, options) {
		return '/detail?page=' + pageNumber;
	};

	// create the category url for a detail-category page
	_helpers.categoryUrl = function (categorySlug, options) {
		return ('/detail/' + categorySlug);
	};
